    ...
    <div>
      ...
      <div className='grid grid-cols-3 max-lg:grid-cols-1 my-[10px] items-center gap-3 justify-center px-6 w-[100%]'>
        <div className='text-center p-3 min-h-[260px]'>
          ...
          <h2 className='font-[600] text-[19px] mb-4'>Satisfaction Guarantee</h2>
        ...
        <div className='text-center p-3  min-h-[260px]'>
          ...
          <h2 className='font-[600] text-[19px] mb-4'>Awesome Technology</h2>
        ...
        <div className='text-center p-3  min-h-[260px]'>
          ...
          <h2 className='font-[600] text-[19px] mb-4'>Professional Doctor</h2>
