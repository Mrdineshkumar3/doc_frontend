...
function Aboutus() {
  return (
    ...
    <div className='flex w-[100%] max-xl:flex-col gap-[100px] bg-[#c900df08] max-sm:p-4  p-[100px] '>
        ...
        <div className='w-[60%] max-sm:w-[100%] p-4'>
            ...
            <div className='py-4'>
                <div className='flex gap-10 max-sm:gap-4 items-center mt-4 '>
                    ...
                    <div>
                        <h2 className='font-[500]'>Complete Health Care</h2>
                ...
                <div className='flex gap-10 max-sm:gap-4 items-center mt-4'>
                    ...
                    <div>
                        <h2 className='font-[500]'>Affordable Price</h2>
